...
CREATE TABLE `games` (
  ...
  PRIMARY KEY (`GAME_ID`),
  CONSTRAINT `chk_game_name` CHECK ((`GAME_NAME` <> _cp850'')),
  CONSTRAINT `chk_genre` CHECK ((`GENRE` <> _cp850''))
...
INSERT INTO `games` VALUES (1001,'The Legend of Zelda: Breath of the Wild','Action-Adventure','Nintendo EPD','2017-03-03'),(1002,'God of War','Action-Adventure','Santa Monica Studio','2018-04-20'),(1003,'Red Dead Redemption 2','Action-Adventure','Rockstar Games','2018-10-26'),(1004,'The Witcher 3: Wild Hunt','RPG','CD Projekt Red','2015-05-19'),(1005,'Minecraft','Sandbox','Mojang Studios','2011-11-18'),(1006,'Fortnite','Battle Royale','Epic Games','2017-07-25'),(1007,'Grand Theft Auto V','Action-Adventure','Rockstar North','2013-09-17'),(1008,'Call of Duty: Modern Warfare','FPS','Infinity Ward','2019-10-25'),(1009,'Overwatch','FPS','Blizzard Entertainment','2016-05-24'),(1010,'Dark Souls III','Action RPG','FromSoftware','2016-04-12'),(1011,'Cyberpunk 2077','RPG','CD Projekt Red','2020-12-10'),(1012,'Elden Ring','Action RPG','FromSoftware','2022-02-25'),(1013,'Spider-Man','Action-Adventure','Insomniac Games','2018-09-07'),(1014,'Horizon Zero Dawn','Action RPG','Guerrilla Games','2017-02-28'),(1015,'Hades','Roguelike','Supergiant Games','2020-09-17'),(1016,'Among Us','Party','InnerSloth','2018-06-15'),(1017,'Fall Guys','Battle Royale','Mediatonic','2020-08-04'),(1018,'Valorant','FPS','Riot Games','2020-06-02'),(1019,'League of Legends','MOBA','Riot Games','2009-10-27'),(1020,'Stardew Valley','Simulation','ConcernedApe','2016-02-26');
...
) ENGINE=InnoDB AUTO_INCREMENT=5068 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_teams_by_region`(
...
-- Dump completed on 2025-11-09 14:40:12
